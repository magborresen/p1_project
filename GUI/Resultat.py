...
class Result(tk.Frame):
    ...
    #    label.place(x=340, y=20)
        ...
        noise_250 = tk.Label(self, text="Dit høretab ved lyde på 250 HZ er " + str(int(noise_induced_250)) + " dBA.")
        noise_250.place(x=85, y=200)

        noise_500 = tk.Label(self, text="Dit høretab ved lyde på 500 HZ er " + str(int(noise_induced_500)) + " dBA.")
        noise_500.place(x=85, y=230)

        noise_1000 = tk.Label(self, text="Dit høretab ved lyde på 1000 HZ er " + str(int(noise_induced_1000)) + " dBA.")
        noise_1000.place(x=85, y=260)

        noise_2000 = tk.Label(self, text="Dit høretab ved lyde på 2000 HZ er " + str(int(noise_induced_2000)) + " dBA.")
        noise_2000.place(x=85, y=290)

        noise_4000 = tk.Label(self, text="Dit høretab ved lyde på 4000 HZ er " + str(int(noise_induced_4000)) + " dBA.")
        noise_4000.place(x=85, y=320)

        noise_8000 = tk.Label(self, text="Dit høretab ved lyde på 8000 HZ er " + str(int(noise_induced_8000)) + " dBA.")
        ...
        if avg_loss <= 25:
            recommendation = "Ingen handing nødvendig. \n Du er bare så god til at passe på din hørelse"
        elif avg_loss <= 40:
